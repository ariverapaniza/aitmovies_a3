...
echo '<div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center">
                <h3 class="text-white">Mystery Genre</h3>
            </div>
        </div>
    </div>';
    ...
    echo '<div class="col-md-3 mb-3">
            <div class="card" style="width: 100%;">
                ...
                <div class="card-body" style="background-color: black;">
                    <h5 class="card-title"><a href="movie_info.php?title=' . urlencode($movie['title']) . '" class="text-white">' . htmlspecialchars($movie['title']) . '</a></h5>
                    <p class="card-text" style="color: white;">' . htmlspecialchars($excerpt) . $readMoreLink . $fullDescription . '</p>
                </div>
            </div>
        </div>';
}
