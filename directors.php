...
echo '<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center mt-3"><h3 class="text-white"> Add Director Information!</h3><br>
            </div>
        </div>
    </div>';
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <form action="form_process_directors.php" method="POST" enctype="multipart/form-data" class="text-left">
                ...
                <div class="form-group">
                    <label for="photo" class="text-white">Director\'s Photo:</label><br>
                ...
                <div class="text-center">
                    <input type="submit" class="btn btn-primary btn-lg" value="Add Director">
                </div><br>
            </form>
            <br>
        </div>
